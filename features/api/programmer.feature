Feature: Programmer
  ...
  Scenario: Create a programmer
    Given I have the payload:
      ...
      """
    When I request "POST /symfony/elearningPlatform/SymfonyCasts/API/Course1/finish/web/api/programmers"
    Then the response status code should be 201
    And the "Location" header should be "/symfony/elearningPlatform/SymfonyCasts/API/Course1/finish/web/api/programmers/ObjectOrienter"
  ...
  Scenario: Proper 404 exception on no programmer
    When I request "GET /symfony/elearningPlatform/SymfonyCasts/API/Course1/finish/web/api/programmers/fake"
  ...
  Scenario: GET one programmer
    Given the following programmers exist:
      ...
      | UnitTester | 3            |
    When I request "GET /symfony/elearningPlatform/SymfonyCasts/API/Course1/finish/web/api/programmers/UnitTester"
  ...
  Scenario: GET a collection of programmers
    Given the following programmers exist:
      ...
      | UnitTester  | 3            |
      | CowboyCoder | 5            |
    When I request "GET /symfony/elearningPlatform/SymfonyCasts/API/Course1/finish/web/api/programmers"
    Then the response status code should be 200
  ...
  Scenario: PUT to update a programmer
    ...
    And I have the payload:
      ...
      """
    When I request "PUT /symfony/elearningPlatform/SymfonyCasts/API/Course1/finish/web/api/programmers/CowboyCoder"
    Then the response status code should be 200
  ...
  Scenario: PATCH to update a programmer
    ...
    And I have the payload:
      ...
      """
    When I request "PATCH /symfony/elearningPlatform/SymfonyCasts/API/Course1/finish/web/api/programmers/CowboyCoder"
    Then the response status code should be 200
  ...
  Scenario: DELETE a programmer
    Given the following programmers exist:
      | nickname   | avatarNumber |
      | UnitTester | 3            |
    When I request "DELETE /symfony/elearningPlatform/SymfonyCasts/API/Course1/finish/web/api/programmers/UnitTester"
